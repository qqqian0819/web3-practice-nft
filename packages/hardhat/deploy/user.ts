...
const func: DeployFunction = async function (hre: any) { // the deploy function receives the hardhat runtime env as an argument
  ...
  await deploy('User', { // This will create a deployment called 'Token'. By default it will look for an artifact with the same name. The 'contract' option allows you to use a different artifact.
